...
public class Tank1 extends GameEntity implements Actor, Vehicle {

	//Architecture similaires a Tank
	...
	public Tank1(ActorGame game, boolean fixed, Vector position) {
		...
		tankShape = new ImageGraphics("tanks_tankDesert_body1.png", 3.6f, 1.3f, new Vector(0.5f, -0.25f));
		tankShape.setParent(getE());

		// CANON
		canonShape = new ImageGraphics("tanks_turret4.png", 1.6f, 0.2f, new Vector(-0.5f, -5.5f));
