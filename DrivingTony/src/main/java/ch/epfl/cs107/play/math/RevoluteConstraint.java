...
/**
 * Constraints two entities to be attached at a single point, allowing some
 * rotation. Limits and motor forces can be enabled.
 */
public class RevoluteConstraint extends Constraint {
	 ...
	 * 
	 * @param enabled
	 *            if true, lower and upper angles are used
	 */
