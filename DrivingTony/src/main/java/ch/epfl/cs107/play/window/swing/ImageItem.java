...
public class ImageItem implements Item {
	 ...
	 * @param transform
	 *            transform used, not null
	 * @param image
	 *            swing image, not null
	 */
	...
	public void render(Graphics2D g) {
		...
		AffineTransform a = new AffineTransform(transform.m00 * sx, transform.m10 * sx, transform.m01 * sy,
				transform.m11 * sy, transform.m02 + transform.m01, transform.m12 + transform.m11);
		if (alpha >= 1.0f)
