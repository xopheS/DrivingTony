...
/**
 * Contains information to render a single string, which can be attached to any
 * positionable.
 */
public class TextGraphics extends Node implements Attachable, Graphics {
	 ...
	 */
	public TextGraphics(String text, float fontSize, Color fillColor, Color outlineColor, float thickness, boolean bold,
			boolean italics, Vector anchor, float alpha, float depth) {
		if (text == null)
	...
	public void draw(Canvas canvas) {
		canvas.drawText(text, fontSize, getTransform(), fillColor, outlineColor, thickness, bold, italics, anchor,
				alpha, depth);
	}
