...
public class PartBuilder {
	...
	/**
	 * Selects which collision categories this part reacts to. Usually, just one bit
	 * is set (by default, the first one, i.e. <code>0x1</code>).
	 * 
	 * @param bits
	 *            bitfield specifying which categories affect this part
	 */
	...
	/**
	 * Selects which collision categories this part affects. By default, all groups
	 * are affected, i.e. <code>0xffff</code>.
	 * 
	 * @param bits
	 *            bitfield specifying which categories affect this part
	 */
	...
	/**
	 * Selects which collision group this part has. Parts in the same negative group
	 * never collide. Parts in the same positive group always collide. By default,
	 * the group 0 is used, which disables collision group for this part. Collision
	 * group always overrides collision categories.
	 * 
	 * @param index
	 *            group index
	 */
