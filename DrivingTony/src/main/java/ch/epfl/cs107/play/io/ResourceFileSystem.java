...
/**
 * Read-only implementation of file system, using native resources bundled with
 * binaries.
 */
public class ResourceFileSystem implements FileSystem {
	 ...
	 * 
	 * @param fallback
	 *            secondary file system used on error, not null
	 * @param loader
	 *            specific binary to use, not null
	 */
