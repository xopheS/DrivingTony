...
public abstract class ConstraintBuilder {
	...
	/**
	 * Sets whether connected entities should continue to consider each other for
	 * collisions.
	 * 
	 * @param collide
	 *            internal collision enabled
	 */
	...
	/**
	 * @return whether connected entities should continue to consider each other for
	 *         collisions
	 */
