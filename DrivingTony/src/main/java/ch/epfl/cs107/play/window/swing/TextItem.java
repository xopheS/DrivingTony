...
public class TextItem implements Item {
	 ...
	 */
	public TextItem(String text, float fontSize, Transform transform, Color fillColor, Color outlineColor,
			float thickness, boolean bold, boolean italics, Vector anchor, float depth, float alpha) {
		this.text = text;
	...
	public void render(Graphics2D g) {
		...
		AffineTransform a = new AffineTransform(transform.m00, transform.m10, -transform.m01, -transform.m11,
