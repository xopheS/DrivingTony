...
public class EntityBuilder {
	 ...
	 * 
	 * @param velocity
	 *            new initial velocity, in radians per second
	 */
	...
	public Entity build() {
		...
		Transform transform = new Transform(c, -s, x, s, c, y);
