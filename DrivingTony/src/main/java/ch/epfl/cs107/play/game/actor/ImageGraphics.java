...
/**
 * Contains information to render a single image, which can be attached to any
 * positionable.
 */
public class ImageGraphics extends Node implements Graphics {
	 ...
	 * 
	 * @param name
	 *            image name, may be null
	 * @param width
	 *            actual image width, before transformation
	 * @param height
	 *            actual image height, before transformation
	 * @param anchor
	 *            image anchor, not null
	 * @param alpha
	...
	public void draw(Canvas canvas) {
		...
		Transform transform = Transform.I.translated(-anchor.x, -anchor.y).scaled(width, height)
				.transformed(getTransform());
