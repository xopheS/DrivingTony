...
/**
 * Represents an open or closed sequence of segments. As it has no mass, it can
 * only be used in fixed bodies.
 */
public final class Polyline extends Shape {
	 ...
	 * 
	 * @param closed
	 *            whether last point is connected to the first one
	 * @param points
	 *            at least two points, not null
	 */
