...
public class Entity implements Positionable {
	 ...
	 * 
	 * @param position
	 *            new linear position, not null
	 * @param angle
	 *            new angular position, in radians
	 */
	...
	public Transform getTransform() {
		if (transform == null) {
			...
			transform = new Transform(c, -s, x, s, c, y);
		}
		return transform;
	}
	 ...
	 * 
	 * @param velocity
	 *            new velocity, in radians per second
	 */
	 ...
	 * 
	 * @param force
	 *            direction and magnitude, not null
	 * @param location
	 *            center of force, at center of mass if null
	 */
	...
	public void destroy() {
		if (world != null) {
			...
			// Note: joints are automatically destroyed by world, using destruction callback
			// to notify our simulator
			world = null;
		}
	}
