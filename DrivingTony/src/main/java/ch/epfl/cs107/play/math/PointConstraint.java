...
/**
 * Attach an entity to a world location, often the mouse coordinates. The second
 * entity is ignored.
 */
public class PointConstraint extends Constraint {
	...
	/**
	 * Sets the maximal force applied to body, as large distances can imply massive
	 * changes.
	 * 
	 * @param force
	 *            maximal force
