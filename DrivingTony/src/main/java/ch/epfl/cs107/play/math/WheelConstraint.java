...
/**
 * Constraints two entities to be act as a car and a wheel. The second entity
 * can move along an axis, constrained by a spring. A motor can be enabled.
 */
public class WheelConstraint extends Constraint {
	 ...
	 * 
	 * @param enabled
	 *            if true, an angular force is applied to match the desired speed
	 */
	 ...
	 * 
	 * @param frequency
	 *            any positive value in hertz, or zero to disable elasticity
	 */
